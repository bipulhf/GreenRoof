...
export default function Home() {
    return (
        <div className="flex max-lg:flex-col justify-between max-lg:min-h-screen">
            <div className="m-[8%]">
                <h1 className="font-extrabold text-greenbtn text-5xl sm:text-7xl md:text-9xl animate-flip-up animate-once animate-ease-in-out">
                    Roof to Root
                </h1>
                <h2 className="mt-[1%] font-extrabold text-cyan text-3xl sm:text-5xl md:text-7xl animate-flip-up animate-once animate-delay-500 animate-ease-in-out">
                    A Unified Connection
                </h2>
                <h3 className="font-bold sm:text-xl md:text-3xl mt-[5%] animate-flip-up animate-once animate-delay-[850ms] animate-ease-in-out">
                    Join Our Rooftop Gardening Community <br /> Where Gardens
                    Flourish and Friendships Grow.
                </h3>
                <div className="mt-[7%] animate-fade-up animate-once animate-delay-[1100ms] animate-ease-in-out">
                    <Link
                        to={"/register"}
